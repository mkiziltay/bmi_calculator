...
class ResultPage extends StatefulWidget {
  ...
  const ResultPage({super.key, required this.height, required this.weight, required this.gender})
      ;
...
class ResultCard extends StatelessWidget {
  ...
  ResultCard({super.key, required this.bmi, required this.minWeight, required this.maxWeight})
      ;
