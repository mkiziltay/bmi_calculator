  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        ...
        TransitionDot(animation: _submitAnimationController, listenable: _submitAnimationController),
      ],
    );
  }
...
class InputSummaryCard extends StatelessWidget {
  ...
  const InputSummaryCard({super.key, required this.gender, required this.height, required this.weight})
      ;
